...
public class ProductProvider extends ContentProvider {
    ...
    /** URI matcher code for the content URI for a single products in the inventory table */
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        if (name == null) {
            throw new IllegalArgumentException("A product item requires a name");
        }
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(ProductContract.ProductEntry.COLUMN_PRODUCT_NAME)) {
            String name = values.getAsString(ProductContract.ProductEntry.COLUMN_PRODUCT_NAME);
            if (name == null) {
                throw new IllegalArgumentException("Product item requires a name");
            }
        }
